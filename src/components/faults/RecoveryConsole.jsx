...
export function RecoveryConsole({ fault, connected = false, onRecoveryComplete }) {
  ...
  const digitalTwin = useDigitalTwin({ enabled: true, topN: 5 });
  ...
  return (
    <div className="space-y-5">
      ...
      <DigitalTwinPanel
        pressure={digitalTwin.pressure}
        stateSummary={digitalTwin.stateSummary}
        candidates={digitalTwin.candidates}
        candidateMessage={digitalTwin.candidateMessage}
        available={digitalTwin.available}
