...
function primaryMetricForFault(fault) {
  ...
  if (id.includes("io-busy") || id.includes("disk-busy")) return "io.busy_percent";
  if (id.includes("io-queue") || id.includes("disk-queue")) return "io.queue_depth";
  if (id.includes("io-latency") || id.includes("disk-latency")) return "io.average_latency_ms";
  if (id.includes("io-throughput") || id.includes("disk-throughput")) return "io.total_MB_per_sec";
